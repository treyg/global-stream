<template>
  <nav class="nav-wrapper">
    <a href="#" class="brand-logo lg-only">
      <img
    ...
    <ul id="nav-list">
      <li>
        <router-link aria-label="Home." to="/"
          ><img class="sm-only" src="../assets/home.svg" /><span class="lg-only"
            >Home</span
          ></router-link
        >
      </li>
      ...
      <li>
        <router-link aria-label="About." to="/about"
          ><img class="sm-only" src="../assets/about.svg" /><span
            class="lg-only"
            >About</span
          ></router-link
        >
